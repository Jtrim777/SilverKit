...
public class SlvStorageHelper {
    ...
    /// The primary app file directories
    public enum Directory {
        ...
        /// The application bundle directory
        case appBundle
        
        /// The application support directory, where all data files should be saved
        case appSupport
    }
